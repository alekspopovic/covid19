...
async function getHistoricalData() {
    ...
    let queryUrl = `https://corona.lmao.ninja/v2/historical/${countries}`;
...
function updateLegend() {
    ...
    if (countryListTrimmed) {
        countryListWasTrimmedText = "<p>Country list has been trimmed to fit the maximum number of chart entries (15).</p>"
    }
